...
<body>
	<nav class="navbar navbar-expand-lg bg-body-tertiary p-0 m-0" style="background-color: #F9CC02;">
		...
		<a href="index.php">
          ...
          <a href="login.html" target="_blank" style="bottom: 13px;"><button class="btnLogin-popup">Login</button></a>
			  </nav>
		  </header>
		  </div>
		</div>
	...
	<ul class="nav nav-tabs" style="position: relative; margin-top: 20px;">
		...
		<li class="nav-item">
			<a class="nav-link" style="color: #363636"; aria-current="page" href="#">História</a>
		</li>
		<li class="nav-item">
