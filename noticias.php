	...
	<div class="content-cards" style="position: relative;bottom: 250px;">
		...
		<div class="row row-cols-1 row-cols-md-3 g-4">
			<div class="col">
				<div class="card h-100">
					<a href="#" target="_blank">
						<img src="img/foto-selecao.png" class="card-img-top" alt="Seleção"></a>
					<div class="card-body">
			...
			<div class="col">
				<div class="card h-100">
					<a href="#" target="_blank">
						<img src="img/noticia-2.png" class="card-img-top" alt="Seleção"></a>
					<div class="card-body">
...
<!-- <div class="row row-cols-2 row-cols-md-4 g-4" style="margin-left: 18px;">
    <div class="col">
      <div class="card" style="width: 400px;">
        <img src="img/comunidadeCard04.jpg" class="card-img-top" alt="jogador de volêi de areia lançando a bola para cima" style="height: 250px;">
        <div class="card-body">
    ...
    <div class="col">
		<div class="card" style="width: 400px;">
        <img src="img/comunidadeCard05.jpg" class="card-img-top" alt="..." style="height: 250px;">
        <div class="card-body">
    ...
    <div class="col">
		<div class="card" style="width: 400px;">
        <img src="img/comunidadeCard06.jpg" class="card-img-top" alt="..." style="height: 250px;">
        <div class="card-body">
    ...
    <div class="col">
		<div class="card" style="width: 400px;">
        <img src="img/comunidadeCard07.jpg" class="card-img-top" alt="..." style="height: 250px;">
        <div class="card-body">
