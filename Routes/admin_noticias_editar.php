            ...
            <main style="padding: 2rem 0 0 0.6rem;">
                <div class="inputs" style="display: flex; flex-direction: column;">
                    <div class="crud-opcoes" style="display: flex; flex-direction: row; gap: 1rem;">
                        <h1 style="margin-bottom: 1rem; font-size: 2.5rem;" name="title-crud">Editar Notícias</h1>
                                ...
                                <?php for ($i = 0; $i < count($noticias); $i++) { ?>
                                    <tr>
                                        <td style="display: flex; justify-content:space-between; align-items: center;">
                                            <?php if ($noticias[$i]['titulo_noticias'] == NULL) {
                                                echo "Nome -> NULL";
                                            } else {
                                                echo htmlspecialchars($noticias[$i]['titulo_noticias']);
                                            } ?>
                                            <a style="text-decoration: none; border: none;" href="../Routes/editar_noticias.php?id=<?php echo $noticias[$i]['id_noticias']; ?>">
                                                <button type="button" name="editar_noticia" class="remove" value="<?php echo $noticias[$i]['id_noticias']; ?>">
